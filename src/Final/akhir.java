        ...
        while(exit = true){
            ...
            switch (pilih){
                ...
                for (int indeks=0; indeks<Jumlah; indeks++) {
                    ...
                    penumpang.tambahPenumpang(new Penumpang(namaPenumpang, idPenumpang, alamatPenumpang, telfonPenumpang, emailPenumpang, calender));
                    ...
                    DataPemesanan pemesanan = new DataPemesanan();
                        ...
                        if (KotaTujuan==1){
                            ...
                            if (KelasKereta==1){
                                ...
                                kursiPmkEko.add(1); kursiPmkEko.add(2); kursiPmkEko.add(3); kursiPmkEko.add(4); kursiPmkEko.add(5);
                                kursiPmkEko.add(6); kursiPmkEko.add(7); kursiPmkEko.add(8); kursiPmkEko.add(9); kursiPmkEko.add(10);
                                ...
                                kursiPmkEks.add(1); kursiPmkEks.add(2); kursiPmkEks.add(3); kursiPmkEks.add(4); kursiPmkEks.add(5);
                                kursiPmkEks.add(6); kursiPmkEks.add(7); kursiPmkEks.add(8); kursiPmkEks.add(9); kursiPmkEks.add(10);
                                ...
                                kursiPmkBis.add(1); kursiPmkBis.add(2); kursiPmkBis.add(3); kursiPmkBis.add(4); kursiPmkBis.add(5);
                                kursiPmkBis.add(6); kursiPmkBis.add(7); kursiPmkBis.add(8); kursiPmkBis.add(9); kursiPmkBis.add(10);
                            ...
                            if (KelasKereta==1){
                                ...
                                kursiSamEko.add(1); kursiSamEko.add(2); kursiSamEko.add(3); kursiSamEko.add(4); kursiSamEko.add(5);
                                kursiSamEko.add(6); kursiSamEko.add(7); kursiSamEko.add(8); kursiSamEko.add(9); kursiSamEko.add(10);
                                ...
                                kursiSamEks.add(1); kursiSamEks.add(2); kursiSamEks.add(3); kursiSamEks.add(4); kursiSamEks.add(5);
                                kursiSamEks.add(6); kursiSamEks.add(7); kursiSamEks.add(8); kursiSamEks.add(9); kursiSamEks.add(10);
                                ...
                                kursiSamBis.add(1); kursiSamBis.add(2); kursiSamBis.add(3); kursiSamBis.add(4); kursiSamBis.add(5);
                                kursiSamBis.add(6); kursiSamBis.add(7); kursiSamBis.add(8); kursiSamBis.add(9); kursiSamBis.add(10);
                            ...
                            if (KelasKereta==1){
                                ...
                                kursiBangEko.add(1); kursiBangEko.add(2); kursiBangEko.add(3); kursiBangEko.add(4); kursiBangEko.add(5);
                                kursiBangEko.add(6); kursiBangEko.add(7); kursiBangEko.add(8); kursiBangEko.add(9); kursiBangEko.add(10);
                                ...
                                kursiBangEks.add(1); kursiBangEks.add(2); kursiBangEks.add(3); kursiBangEks.add(4); kursiBangEks.add(5);
                                kursiBangEks.add(6); kursiBangEks.add(7); kursiBangEks.add(8); kursiBangEks.add(9); kursiBangEks.add(10);
                                ...
                                kursiBangBis.add(1); kursiBangBis.add(2); kursiBangBis.add(3); kursiBangBis.add(4); kursiBangBis.add(5);
                                kursiBangBis.add(6); kursiBangBis.add(7); kursiBangBis.add(8); kursiBangBis.add(9); kursiBangBis.add(10);
